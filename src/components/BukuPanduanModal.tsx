...
export const BukuPanduanModal: React.FC<BukuPanduanModalProps> = ({
  ...
  const panduanJamaah = [
    ...
    },
    {
      ...
      steps: [
        ...
        'Setelah transfer berhasil, upload foto bukti pembayaran (bukti fisik akan tersimpan permanen di cloud storage).',
  ...
  const panduanAdmin = [
    ...
    },
    {
      ...
      tip: 'Pengaturan otorisasi ini menjamin transparansi, keamanan, serta memastikan tugas diselesaikan oleh PIC yang tepat.',
    },
    {
      id: 'a-6',
      icon: Layers,
      title: '6. Manajemen Inventaris & Penyimpanan Aset',
      summary: 'Cara mengelola aset fisik masjid lengkap dengan upload foto ke Supabase Storage.',
      steps: [
        'Akses modul **Administrasi -> Inventaris Aset**.',
        'Klik **+ Tambah Aset**, lalu isi Nama Barang, Kondisi, Lokasi, dan Kategori.',
        'Unggah/upload **Foto Fisik Aset**. File foto akan otomatis dikompresi dan dikirim ke server penyimpanan awan (Supabase Cloud Storage).',
        'Setelah tersimpan, foto tidak akan hilang atau tertimpa karena memiliki ID Unik permanen.',
      ],
      tip: 'Sistem penyimpanan awan memastikan aset digital tidak membebani memori perangkat lokal dan dapat diakses dari mana saja.',
    },
  ];
